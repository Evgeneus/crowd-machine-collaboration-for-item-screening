...
class StackingEnsemble(MachineEnsemble):
    ...
    def run(self):
        ...
        meta_clf = MetaClassifier(LogisticRegression(class_weight={1: 1, 0: self.lr}))
        ...
        ensembled_votes = list(meta_clf.predict_proba(votes_list))
    ...
    def _get_machines(self):
        return np.random.uniform(0.5, 0.95, self.machines_num)
        # return [1.] * self.machines_num
